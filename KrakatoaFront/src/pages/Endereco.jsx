                    ...
                    <div style={{ display: 'flex', flexDirection: 'row', marginTop: '50px' }}>
                        ...
                        <div style={{ display: 'flex', flex: '1', flexDirection: 'column' }}>
                            <div style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center' }}>
                                <p style={{ fontFamily: 'Poppins', fontWeight: 'bold' }}>Tipo de entrega</p>
                            </div>

                            <div style={{ display: 'flex', flex: '1', flexDirection: 'row', justifyContent: 'space-around', marginLeft: '20px' }} >
                                <Box
                                    onClick={() => {
                                    ...
                                    <p style={{ fontFamily: 'Poppins', fontWeight: 'bold' }}>{this.state.pricePac}</p>
                                    <p style={{ fontFamily: 'Poppins', fontWeight: 'bold' }}>{this.state.diasUteisPac} dias úteis</p>
                                </Box>
                                ...
                                <Box
                                    ...
                                    borderRadius={16}
                                    flexDirection="column"
                                    alignItems="center"{...styles.boxStyle}>
                                    <div style={{ paddingBottom: '15px' }}>
                                        <img src={Sedex} alt="React Logo" />
                                    </div>
                                    <p style={{ fontFamily: 'Poppins', fontWeight: 'bold' }}>{this.state.priceSedex}</p>
                                    <p style={{ fontFamily: 'Poppins', fontWeight: 'bold' }}>{this.state.diasUteisSedex} dias úteis</p>
                                </Box>

                            </div>
                            <MuiThemeProvider theme={theme}> 
                            <div style={{ marginTop: '20px', display: 'flex', flexDirection: 'row', flex: '1', justifyContent: 'flex-end', fontFamily: 'Poppins' }}>
                                <Button style={{ width: '30%' }} variant="contained" color="primary" >Continuar</Button>
                            </div>
                            </MuiThemeProvider>
                        </div>
                    </div>
