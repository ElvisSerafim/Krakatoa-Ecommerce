...
const ItemMobile = ({ produto, removerItem, posicao, diminuirQuantia, aumentarQuantia }) => {
        ...
        <>
            <div className={classes.DivItem}>
                <div style={{ padding: '0px 30px 30px 30px' }}>
                    ...
                    <Grid justify="space-around" container direction='row' item style={{ paddingTop: 15 }}>
                    ...
                    <div style={{ paddingTop: 15 }}>
                        <div style={Estilos.flexRowSPACEBTW}>
                            ...
                            <div style={Estilos.flexRowCENTER}>
                                <Typography style={style.typographyPrice}>R$ {total}</Typography>
                            </div>
                        </div>
                    </div>
                </div>
