...
const Carrinho = () => {
  ...
  const atualizarTotalList = (valorFinal:number) => {
  ...
  useEffect(() => {
    ...
    setTotal(parseInt(totally.toFixed(2)));
  ...
  return (
    <>
      ...
      <Container maxWidth="lg">
        {length === 0 ? (
          <Box flexDirection="row" justifyContent="center" alignItems="center" style={{ padding: 64 }}>
            <Typography
              color="primary"
              variant="h5"
